...
Phase 6 calculates only pilot instrumentation and runtime projections. Metrics from fake or mini pilot conditions are labelled simulated/pilot-only and must not enter final RQ analysis.
