...
An evaluation activation manifest must bind the approved checkpoint/replay, perturbation, solvability, recovery-context, action-budget, and timeout evidence before final recovery evaluation can be enabled.
